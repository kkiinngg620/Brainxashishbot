...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [   
	    InlineKeyboardButton(text='⚡Join Backup Channel⚡', url=f'https://t.me/Mhubnetwork')
        ]   
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            return await query.answer('♥️ Love @moviieeadda3 ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📥 Join Backup Channel 📥', url=f'https://t.me/Mhubnetwork')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    mm = await msg.reply("I couldn't find anything related to that\nDid you mean any one of these?",
                    reply_markup=InlineKeyboardMarkup(btn))
    await asyncio.sleep(1)
    await mm.delete()
